...
SECTION_SPECS: Dict[str, Tuple[str, List[FieldSpec]]] = {
    "downloads": (
        ...
        [
            ...
            FieldSpec(
                "source_subdirectories", "Put albums in source subfolders", "bool"
            ),
    ...
    "conversion": (
        ...
        [
            ...
            FieldSpec(
                ...
                "Codec",
                "combo",
                {"items": ["FLAC", "ALAC", "OPUS", "MP3", "AAC", "OGG"]},
            ),
            FieldSpec(
                "sampling_rate",
                "Downsample above (Hz)",
                "int",
                {"min": 8000, "max": 384000, "step": 1000},
            ),
            FieldSpec(
                "bit_depth", "Target bit depth", "combo", {"items": ["16", "24"]}
            ),
            FieldSpec(
                "lossy_bitrate",
                "Lossy bitrate (kbps)",
    ...
    "tidal": (
        ...
        [
            FieldSpec(
                "quality", "Audio quality", "quality", {"values": [0, 1, 2, 3, 4]}
            ),
    ...
    "artwork": (
        ...
        [
            ...
            FieldSpec(
                ...
                "Embed size",
                "combo",
                {"items": ["thumbnail", "small", "large", "original"]},
            ),
            FieldSpec(
                "embed_max_width",
                "Embed max width (px)",
    ...
    "metadata": (
        ...
        [
            ...
            FieldSpec(
                "renumber_playlist_tracks", "Use playlist order for track #", "bool"
            ),
...
class ConfigPanel(QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.setStyleSheet(
            ...
            QLabel, QCheckBox, QLineEdit, QComboBox, QSpinBox, QPlainTextEdit { color: 
        """
        )
    ...
    def _make_widget(self, fs: FieldSpec) -> QtWidgets.QWidget:
        ...
        if k == "list":
            ...
            te.setPlaceholderText("One per line")
    ...
    def _load_section(self, section: str):
        ...
        for fs in fields:
            self._set_widget_value(
                self._widgets[(section, fs.key)], fs, data.get(fs.key)
            )
    ...
    def _set_widget_value(self, w: QtWidgets.QWidget, fs: FieldSpec, val: Any):
        if fs.kind == "bool":
            ...
            if idx < 0:
                idx = w.findText(str(val or ""), Qt.MatchFixedString)
            if idx >= 0:
            ...
            le: QtWidgets.QLineEdit = w._lineedit
            le.setText(str(val or ""))
        elif fs.kind == "list":
            te: QtWidgets.QPlainTextEdit = w
